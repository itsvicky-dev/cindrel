...
export const PRICING_PLANS = [
  {
    plan:'Starter', price:'$200', inr:'≈ ₹16,700', period:'/month', featured:false,
    desc:'For startups and small teams with 1–3 automation workflows to build and launch fast.',
    features:[
  ...
  {
    plan:'Professional', price:'$800', inr:'≈ ₹66,800', period:'/month', featured:true,
    desc:'For growing businesses needing advanced automation across multiple functions.',
    features:[
