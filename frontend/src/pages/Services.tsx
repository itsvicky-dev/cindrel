...
const DETAILS = [
  { 
    ...
    desc: 'Design and deploy intelligent, event-driven workflows that eliminate repetitive tasks and streamline operations — from simple automations to complex, multi-system processes.', 
    features: [
    ...
    tag: 'n8n · Zapier · Make · Custom' 
  },
  { 
    num: '02', 
    icon: '🤖', 
    title: 'AI Agents & Intelligent Bots', 
    desc: 'Build advanced AI-powered agents that understand context, make decisions, and take action — transforming customer interactions, internal operations, and data workflows.', 
    features: [
      'Custom AI agents (GPT-4 / Claude) tailored to your use case', 
      'CRM-integrated customer support automation', 
      'Lead qualification and sales assistants', 
      'Internal knowledge base copilots', 
      'Autonomous research and data-processing agents'
    ], 
    tag: 'OpenAI · LangChain · Custom LLMs' 
  },
  { 
    num: '03', 
    icon: '🔗', 
    title: 'API & System Integrations', 
    desc: 'Seamlessly connect your tools, platforms, and data sources into one unified ecosystem — ensuring smooth, reliable data flow across your business.', 
    features: [
      'REST API and GraphQL integrations', 
      'Webhooks and event-driven architectures', 
      'Bi-directional CRM integrations (e.g., HubSpot, Salesforce)', 
      'Payment gateway and third-party service integrations', 
      'Custom middleware and data transformation solutions'
    ], 
    tag: 'REST APIs · Webhooks · OAuth' 
  },
  { 
    num: '04', 
    icon: '📊', 
    title: 'Data Automation & Analytics', 
    desc: 'Turn raw, scattered data into structured, actionable insights with fully automated pipelines, dashboards, and reporting systems.', 
    features: [
      'Automated report generation and distribution', 
      'Real-time KPI dashboards (Looker, Metabase, etc.)', 
      'Data pipeline architecture and ETL automation', 
      'Centralized data warehousing solutions', 
      'AI-generated executive summaries and insights'
    ], 
    tag: 'BigQuery · Sheets · Airtable · Metabase' 
  },
  { 
    num: '05', 
    icon: '🛠️', 
    title: 'No-Code / Low-Code Automation', 
    desc: 'Launch powerful automation workflows quickly using intuitive no-code and low-code platforms — enabling faster delivery while empowering your team to manage and scale independently.', 
    features: [
      'Rapid workflow design and deployment', 
      'Advanced automation using Zapier, Make (Integromat), and n8n', 
      'Scalable, secure cloud or self-hosted setups', 
      'Easy maintenance with minimal technical dependency', 
      'Team enablement, training, and documentation',
      'Ongoing support and optimization packages'
    ], 
    tag: 'n8n · Zapier · Make · Pabbly' 
  },
  { 
    num: '06', 
    icon: '💻', 
    title: 'Custom Automation Development', 
    desc: 'Build fully tailored automation solutions for complex business needs that go beyond off-the-shelf tools — engineered for performance, flexibility, and scale.', 
    features: [
      'Custom automation scripts using Python and Node.js', 
      'Cloud-native solutions (AWS Lambda, GCP, serverless architecture)', 
      'Database automation and scheduled job orchestration', 
      'Intelligent document processing and OCR workflows', 
      'Browser automation (Playwright, Puppeteer)',
      'Scalable systems designed for high-volume operations'
    ], 
    tag: 'Python · Node.js · AWS · GCP' 
  },
]
  ...
  return (
    <>
      <PageHero badge="AI Automation Services"
        title={<>Automation That <br />Powers Every<br /> Part of Your Business</>}
        sub="From no-code workflows to advanced AI systems, we build automation tailored to your exact needs.
 Reduce manual effort, improve efficiency, and scale your business with confidence." />
